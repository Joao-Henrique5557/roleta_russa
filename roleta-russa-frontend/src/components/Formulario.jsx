    ...
    if (tipo === "login") {
        return (
            <form className="form" onSubmit={handleSubmit}>
                ...
                <p>Não tem uma conta? <button type="button" className="link-button" onClick={onSwitch}>Cadastre-se</button></p>
            </form>
        )
        ...
        return (
            <form className="form" onSubmit={handleSubmit}>
                ...
                <p>Já tem uma conta? <button type="button" className="link-button" onClick={onSwitch}>Faça login</button></p>
            </form>
        )
    }
}
